...
data_PSR <- data_PSR %>% mutate(MUNICIPIO_CORRIGIDO = 
                                    ...
                                    NM_MUNICIPIO_PROPRIEDADE == "JARDIM"& SG_UF_PROPRIEDADE == "PR"~"LONDRINA",
                                    ...
                                    NM_MUNICIPIO_PROPRIEDADE == "JUCIARA"& SG_UF_PROPRIEDADE == "PR"~"KALORÉ",
                                    ...
                                    NM_MUNICIPIO_PROPRIEDADE == "GAMADINHO"& SG_UF_PROPRIEDADE == "PR"~"CASCAVEL",
                                    NM_MUNICIPIO_PROPRIEDADE == "BOCAJÁ"& SG_UF_PROPRIEDADE == "MS"~"DOURADINA",
                                    ...
                                    NM_MUNICIPIO_PROPRIEDADE == "CRUZALTINA"& SG_UF_PROPRIEDADE == "MS"~"DOURADINA",
                                    NM_MUNICIPIO_PROPRIEDADE == "ROMEÓPOLIS"& SG_UF_PROPRIEDADE == "PR"~"ARAPUÃ",
                                    ...
                                    NM_MUNICIPIO_PROPRIEDADE == "PULINÓPOLIS"& SG_UF_PROPRIEDADE == "PR"~"MANDAGUAÇU",
                                    ...
                                    NM_MUNICIPIO_PROPRIEDADE == "FORMIGUEIRO"& SG_UF_PROPRIEDADE == "PR"~"ARAUCÁRIA",
                                    ...
                                    NM_MUNICIPIO_PROPRIEDADE == "PANEMA"& SG_UF_PROPRIEDADE == "PR"~"SANTA MARIANA",
                                    ...
                                    NM_MUNICIPIO_PROPRIEDADE == "SÃO GABRIEL"& SG_UF_PROPRIEDADE == "PR"~"COLOMBO",
                                    NM_MUNICIPIO_PROPRIEDADE == "RIO DAS ANTAS"& SG_UF_PROPRIEDADE == "PR"~"CASCAVEL",
