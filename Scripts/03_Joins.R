...
PSR_soja_mun <- data_PSR %>% 
  ...
  summarise(
    ...
    VL_TOTAL = sum(VL_LIMITE_GARANTIA),
...
PSR_soja_mun$VL_TOTAL_Medio           = PSR_soja_mun$VL_TOTAL/PSR_soja_mun$num_seguros
...
Proagro_soja_mun_programa$VL_TOTAL_Medio          = Proagro_soja_mun_programa$VL_TOTAL/Proagro_soja_mun_programa$num_seguros
Proagro_soja_mun_programa$VL_PREMIO_PAGO_Medio    = Proagro_soja_mun_programa$VL_Premio/Proagro_soja_mun_programa$num_seguros
...
Proagro_soja_mun_programa$VL_SINISTRO_MEDIO       = Proagro_soja_mun_programa$VL_SINISTROS/Proagro_soja_mun_programa$QT_SINISTROS


PSR_Proagro_Union_Mun <- union_all(
  x = Proagro_soja_mun %>%  select ( -c("Receita_Media", "RECEITA_ESTIMADA", "VL_FIN",	"VL_RECP",	"VL_INV",	"VL_GRM")),
  y = PSR_soja_mun %>%  select(-c("Produtividade_Seg_Media", "Produtividade_Media", "VL_PREMIO_LIQUIDO", "NR_PRODUTIVIDADE_SEGURADA", "NR_PRODUTIVIDADE_ESTIMADA"))
)



PSR_Proagro_Union_Mun_Programa <- union_all(
  x = Proagro_soja_mun_programa %>%  select ( -c("Receita_Media", "RECEITA_ESTIMADA", "VL_FIN",	"VL_RECP",	"VL_INV",	"VL_GRM")),
  y = PSR_soja_mun_programa %>%  select(-c("Produtividade_Seg_Media", "Produtividade_Media", "VL_PREMIO_LIQUIDO", "NR_PRODUTIVIDADE_SEGURADA", "NR_PRODUTIVIDADE_ESTIMADA"))
)
...
Proagro_soja_regiao$Limite_Medio             = Proagro_soja_regiao$VALOR_TOTAL/Proagro_soja_regiao$num_seguros
