...
print(descr(Proagro_soja_mun$VL_TOTAL_Medio_Defl, headings = FALSE), method = "render", headings = FALSE)
```
...
print(descr(Proagro_soja_mun$Premio_Liquido_Medio_Defl, headings = FALSE), method = "render", headings = FALSE)
```
