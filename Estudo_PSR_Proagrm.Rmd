...
```{r, results="hide"}
table <- ctable(Proagro_soja_mun_safra$PROGRAMA, Proagro_soja_mun_safra$SAFRA, prop = "r", weights = Proagro_soja_mun_safra$num_seguros, headings = FALSE)[[1]] %>%  kable() %>% kable_styling()
```
...
ctable(Proagro_soja_mun$PROGRAMA, Proagro_soja_mun$TP_SEGURO, prop = "r", weights = Proagro_soja_mun$num_seguros, headings = FALSE)
