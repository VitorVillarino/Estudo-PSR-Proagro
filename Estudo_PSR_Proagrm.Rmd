...
if(plot_maps) {
  plot_mun_brasil_alt(Proagro_soja_mun[Proagro_soja_mun$PROGRAMA == "PRONAF",],"VL_TOTAL_Medio_Area_Defl", "Valor/Área - PRONAF")
}
```
...
if(plot_maps) {
  plot_mun_brasil_alt(Proagro_soja_mun[Proagro_soja_mun$PROGRAMA == "PRONAMP",],"VL_TOTAL_Medio_Area_Defl", "Valor/Área - PRONAMP")
}
```

```{r valor_medio_area_proagro_mapa_Sem_Programa, fig.height=6}
if(plot_maps) {
  plot_mun_brasil_alt(Proagro_soja_mun[Proagro_soja_mun$PROGRAMA == "SEM PROGRAMA",],"VL_TOTAL_Medio_Area_Defl", "Valor/Área - SEM PROG")
}
```
...
if(plot_maps) {
  plot_mun_brasil_alt(Proagro_soja_mun[Proagro_soja_mun$PROGRAMA == "PRONAF",],"Premio_Liquido_Medio_Defl", "Prêmio Médio - PRONAF")
}
```
...
if(plot_maps) {
  plot_mun_brasil_alt(Proagro_soja_mun[Proagro_soja_mun$PROGRAMA == "PRONAMP",],"Premio_Liquido_Medio_Defl", "Prêmio Médio - PRONAMP")
}
```

```{r premio_medio_proagro_mapa_Sem_Programa, fig.height=6}
if(plot_maps) {
  plot_mun_brasil_alt(Proagro_soja_mun[Proagro_soja_mun$PROGRAMA == "SEM PROGRAMA",],"Premio_Liquido_Medio_Defl", "Prêmio Médio- SEM PROG")
}
```
...
if(plot_maps) {
  plot_mun_brasil_alt(Proagro_soja_mun[Proagro_soja_mun$PROGRAMA == "PRONAF",],"Premio_Area_Defl", "Prêmio/Área - PRONAF")
}
```
...
if(plot_maps) {
  plot_mun_brasil_alt(Proagro_soja_mun[Proagro_soja_mun$PROGRAMA == "PRONAMP",],"Premio_Area_Defl", "Prêmio/Área - PRONAMP")
}
```

```{r premio_medio_area_proagro_mapa_Sem_Programa, fig.height=6}
if(plot_maps) {
  plot_mun_brasil_alt(Proagro_soja_mun[Proagro_soja_mun$PROGRAMA == "SEM PROGRAMA",],"Premio_Area_Defl", "Prêmio/Área - SEM PROG")
}
```
...
if(plot_maps) {
  plot_mun_brasil_alt(Proagro_soja_mun[Proagro_soja_mun$PROGRAMA == "PRONAF",],"INDICE_SINISTRO_QTD", "Índice Incidência - PRONAF")
}
```
...
if(plot_maps) {
  plot_mun_brasil_alt(Proagro_soja_mun[Proagro_soja_mun$PROGRAMA == "PRONAMP",],"INDICE_SINISTRO_QTD", "Índice Incidência - PRONAMP")
}
```

```{r indice_incidencia_proagro_mapa_Sem_Programa, fig.height=6}
if(plot_maps) {
  plot_mun_brasil_alt(Proagro_soja_mun[Proagro_soja_mun$PROGRAMA == "SEM PROGRAMA",],"INDICE_SINISTRO_QTD", "Índice Incidência - SEM PROG")
}
```
...
if(plot_maps) {
  plot_mun_brasil_alt(Proagro_soja_mun[Proagro_soja_mun$PROGRAMA == "PRONAF",],"VL_SINISTRO_MEDIO_Defl", "Índice Incidência - PRONAF")
}
```
...
if(plot_maps) {
  plot_mun_brasil_alt(Proagro_soja_mun[Proagro_soja_mun$PROGRAMA == "PRONAMP",],"VL_SINISTRO_MEDIO_Defl", "Índice Incidência - PRONAMP")
}
```

```{r sinistro_medio_proagro_mapa_Sem_Programa, fig.height=6}
if(plot_maps) {
  plot_mun_brasil_alt(Proagro_soja_mun[Proagro_soja_mun$PROGRAMA == "SEM PROGRAMA",],"VL_SINISTRO_MEDIO_Defl", "Índice Incidência - SEM PROG")
}
```
...
if(plot_maps) {
  plot_mun_brasil_alt(Proagro_soja_mun[Proagro_soja_mun$PROGRAMA == "PRONAF",],"INDICE_SINISTRO_VALOR_Defl", "Índice Incidência - PRONAF")
}
```
...
if(plot_maps) {
  plot_mun_brasil_alt(Proagro_soja_mun[Proagro_soja_mun$PROGRAMA == "PRONAMP",],"INDICE_SINISTRO_VALOR_Defl", "Índice Incidência - PRONAMP")
}
```

```{r indice_sinistro_valor_proagro_mapa_Sem_Programa, fig.height=6}
if(plot_maps) {
  plot_mun_brasil_alt(Proagro_soja_mun[Proagro_soja_mun$PROGRAMA == "SEM PROGRAMA",],"INDICE_SINISTRO_VALOR_Defl", "Índice Incidência - SEM PROG")
}
```
