...
```{r comparacao_inflacao_medio, caption = "Distribuição - Valores Médios Originais", fig.align="center", fig.width=6}
...
```{r comparacao_inflacao_deflacionado, caption = "Distribuição - Valores Médios Deflacionados", fig.align="center", fig.width=6}
...
if(plot_maps) {
  plot_mun_brasil_alt(stat_Maior_30,"Qt_Seguros")  
}
```
...
```{r valor_medio_defl_area_grafico, fig.align="center", fig.width=6}
...
```{r valor_medio_defl_area_mapa}
if(plot_maps) {
  plot_mun_brasil_alt(Proagro_soja_mun_geral,"VL_TOTAL_Medio_Area_Defl")
}
```
...
```{r premio_medio_defl_area_grafico, fig.align="center", fig.width=6}
ggplot(Proagro_soja_mun_geral) +
...
```{r premio_medio_defl_area_mapa}
if(plot_maps) {
  plot_mun_brasil_alt(Proagro_soja_mun_geral,"Premio_Area_Defl")
}
```
...
```{r qtd_sinistros_qt_total_grafico, fig.align="center", fig.width=6}
ggplot(Proagro_soja_mun_geral) +
...
```{r qtd_sinistros_qt_total_sem_zero_grafico, fig.align="center", fig.width=6}
...
```{r qtd_sinistros_defl_medio_geral_grafico, fig.align="center", fig.width=6}
ggplot(Proagro_soja_mun_geral) +
...
```{r sinistralidae_defl_geral_grafico, fig.align="center", fig.width=6}
ggplot(Proagro_soja_mun_geral) +
 aes(x = SINISTRALIDADE_Defl ) +
 geom_histogram(bins = 30L, fill = "#0c4c8a") +
 theme_minimal()

print(descr(Proagro_soja_mun_geral$SINISTRALIDADE_Defl, headings = FALSE,  stats = c("mean","sd","min","q1","med","q3","max","mad","iqr")), method = "render", headings = FALSE)

```



```{r sinistralidae_defl_geral_sem_zero_grafico, fig.align="center", fig.width=6}
...
print(descr(Proagro_soja_mun_geral[Proagro_soja_mun_geral$SINISTRALIDADE_Defl > 0,"SINISTRALIDADE_Defl"], headings = FALSE,  stats = c("mean","sd","min","q1","med","q3","max","mad","iqr")), method = "render", headings = FALSE)
...
```{r valor_medio_proagro_grafico, fig.align="center", fig.width=6}
...
```{r premio_medio_proagro_grafico, fig.align="center", fig.width=6}
ggplot(Proagro_soja_mun) +
...
```{r valor_medio_area_proagro_grafico, fig.align="center", fig.width=6}
ggplot(Proagro_soja_mun) +
