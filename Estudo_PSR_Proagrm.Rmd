...
```{r premio_medio_defl_area_grafico,  fig.width=6}
ggplot(Proagro_soja_mun_geral) +
...
```{r qtd_sinistros_qt_total_sem_zero_grafico,  fig.height = 6}
...
```{r qtd_sinistros_qt_total_sem_zero_mapa,  fig.width=6, fig.height=6}
if(plot_maps) {
...
```{r sinistralidae_defl_geral_grafico,  fig.width=6}
ggplot(Proagro_soja_mun_geral) +
...
```{r sinistralidae_defl_geral_sem_zero_grafico,  fig.width=6}
